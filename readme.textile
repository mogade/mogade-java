...
for(String achievementId : response.getAchievements())
{
   //get achievement from config data by id
...
//Maybe check the obtain UserGameData and see if they have already obtained this achievement and don't save again??
